...
void Vehicle::drive()
{
    ...
    while (true)
    {
        ...
        if (timeSinceLastUpdate >= cycleDuration)
        {
            ...
            {
                // Task L2.1 : Start up a task using std::async which takes a reference to the method Interestection::addVehicleToQueue, 
